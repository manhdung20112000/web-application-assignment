...
var varDeclared = ['varDeclared', 'p1Message', 'p2Message'];
...
// Once the browser loads our companion HTML in test-lab5.html we
// update it with the results of our testing. This code will make more
// sense after the next project.
window.onload = function () {
    document.getElementById("lab5p1").innerHTML = p1Message;
    document.getElementById("lab5p2").innerHTML = p2Message;
};
